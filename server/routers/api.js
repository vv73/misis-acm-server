...
router.get('/admin/getCondition', function (req, res) {
    ...
    function execute(callback) {
        ...
        adminManager.getCondition(q.problem_id, function (err, result) {
            if (err) {
                return callback({
                    error: err.toString()
                });
...
router.post('/admin/updateCondition', function (req, res) {
    ...
    function execute(callback) {
        ...
        adminManager.updateCondition(body, function (err, result) {
            if (err) {
                return callback({
                    error: err.toString()
                });
...
router.post('/admin/createEjudgeProblem', function (req, res) {
    ...
    function execute(callback) {
        ...
        adminManager.createEjudgeProblem(body, function (err, result) {
            if (err) {
                return callback({
                    error: err.toString()
                });
...
router.get('/admin/getUser', function (req, res) {
    ...
    function execute(callback) {
        ...
        adminManager.getUser(q.user_id, function (err, result) {
            if (err) {
                return callback({
                    error: err.toString()
                });
...
router.post('/admin/updateUser', function (req, res) {
    ...
    function execute(callback) {
        ...
        adminManager.updateUser(body.user_id, body, function (err, result) {
            if (err) {
                return callback({
                    error: err.toString()
                });
...
router.post('/contest/markAsRead', function (req, res) {
...
router.post('/contest/postMessage', function (req, res) {
    ...
    function execute(callback) {
        ...
        body.user = user;
        contestManager.postMessage(body, function (err, result) {
            if (err) {
                return callback({
                    error: err.toString()
                });
